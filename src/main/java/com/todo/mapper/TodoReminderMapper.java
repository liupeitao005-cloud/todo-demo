...
public interface TodoReminderMapper {
    ...
    @Select("SELECT id,user_id,target_type,target_id,title,content,remind_time,channel,is_sent,create_time,update_time FROM todo_reminder WHERE id=#{id}")
    TodoReminder selectByIdOnly(Long id);
